...
export default function UpvoteButton({ handleOnClick, isSelected }) {
  return (
    <button className={`buttonBackground ${isSelected ? styles.backgroundSelected : styles.backgroundDeselected}`} onClick={handleOnClick}>
      <svg className={`${isSelected ? styles.arrowSelected : styles.arrowDeselected}`} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
